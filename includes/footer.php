<footer>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://royinformatics.com" target="_blank">Roy Informatics Pvt. Ltd.</a>
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
                    ...
                    <div class="col-xl-3 col-lg-4">
                        ...
                        <div class="footer-social f-right">
                            ...
                            <a href="https://www.facebook.com/itzroyinformatics/"><i class="fab fa-facebook-f"></i></a>
                            <a href="https://www.linkedin.com/company/itzroyinformatics/"><i class="fab fa-linkedin-in"></i></a>
                            <a href="https://www.instagram.com/itzroyinformatics/"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                </div>
            </div>
